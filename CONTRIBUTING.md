...
```bash
git clone https://github.com/faubulous/mentor-rdf-parsers.git
cd mentor-rdf-parsers
npm install
```
...
[GitHub](https://github.com/faubulous/mentor-rdf-serializers/issues) with a
