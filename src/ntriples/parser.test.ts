 ...
 * official W3C RDF Test Suite for N-Triples, distributed under the W3C
 ...
 *     --manifest src/tree-sitter-ntriples/tests/manifest.ttl \
 *     -p TestNTriplesPositiveSyntax \
 *     -n TestNTriplesNegativeSyntax \
 *     -e .nt
 *
